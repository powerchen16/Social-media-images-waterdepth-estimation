...
model.load_state_dict(torch.load('/home/cuiaoxue/project/qianmengchen/waterdepth/SwinT_weights/pytorch_model.bin'))   # 加载预训练权重
...
for epoch in range(num_epochs):
    ...
    # save model
    torch.save(model.state_dict(), "/home/cuiaoxue/project/qianmengchen/waterdepth/SwinT-Rank/SwinT-rank-last.pt")
    if acc_val == max(val_acc_list):
        torch.save(model.state_dict(), "/home/cuiaoxue/project/qianmengchen/waterdepth/SwinT-Rank/SwinT-rank-best.pt")
...
plt.savefig('/home/cuiaoxue/project/qianmengchen/waterdepth/SwinT-Rank/SwinT-rank-128-1e-4-数增-1e-4.png')
plt.show()
